...
import at.epu.DataAccessLayer.DataProviders.SQLQueryProvider;
...
public abstract class BackofficeTableModel extends DefaultTableModel implements FilterableDataModel {
	...
	SQLQueryProvider sqlProvider  = null;							//used in the SQL Models to get data from Database
	MockDataProvider mockProvider = null;							//used in the Mock Models to save/update/delete Data properly
	...
	protected DataObjectCollection dataObjects = null;
	...
	protected Object[][] presented_data = null;								//used for filtered data
	...
	protected SQLQueryProvider getSQLQueryProvider() {
		if(sqlProvider == null)
		{
			sqlProvider = new SQLQueryProvider();
		}
		
		return sqlProvider;
	}
	
	protected MockDataProvider getMockDataProvider() {
